export let mode = [{
  ...
  check: function (i, j) {
    return i === this.num || this.col - j + 1 === this.num;
  },
  next: function () {
    this.num++;
  },
  ...
  check: function (i, j) {
    return this.row - i + 1 === this.num || j === this.num;
  },
  next: function () {
    this.num++;
  },
  ...
  check: function (i, j) {
    return i === this.num || j === this.num || this.row - i + 1 === this.num || this.col - j + 1 === this.num;
  },
  next: function () {
    this.num++;
  },
  ...
  init: function (row, col) {
    this.row = row
    this.col = col
    this.num = this.row > this.col ? Math.floor(this.col / 2) : Math.floor(this.row / 2)
    this.start = (this.row > this.col ? 'this.col' : 'this.row')
  },
  check: function (i, j) {
    if (this.start === 'this.row') {
      return i - this.num >= 1 && i + this.num < this.row + 1 && j - this.num >= 1 && j + this.num < this.col + 1;
    }
    if (this.start === 'this.col') {
      return j - this.num >= 1 && j + this.num < this.col + 1 && i - this.num >= 1 && i + this.num < this.row + 1;
    }
  },
  next: function () {
    this.num--;
